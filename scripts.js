...
const segunda_daniel = "FOLGA";
const terca_valmir = "FOLGA";
const quarta_elias = "FOLGA";
const quinta_carlinhos = "FOLGA";
const sexta_valmir = "FOLGA";
const sabado_daniel = "FOLGA";
